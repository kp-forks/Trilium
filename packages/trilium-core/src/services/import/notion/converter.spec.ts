...
describe("convertNotionHtml — toggles", () => {
    it("unwraps a Notion toggle into a bare collapsible <details>", () => {
        ...
        expect(convertNotionHtml(input)).toBe(
            `<details class="trilium-collapsible"><summary>Toggle title</summary><p>Content goes here.</p><p>And here.</p></details>`
        );
    });
    ...
    it("handles a toggle with no body and an empty summary", () => {
        expect(convertNotionHtml(`<ul class="toggle"><li><details open=""><summary>Title only</summary></details></li></ul>`)).toBe(
            `<details class="trilium-collapsible"><summary>Title only</summary></details>`
        );
    ...
    it("keeps a nested toggle nested rather than flattening it", () => {
        ...
        expect(convertNotionHtml(input)).toBe(
            `<details class="trilium-collapsible"><summary>Outer</summary><details class="trilium-collapsible"><summary>Inner</summary></details></details>`
        );
    });
});
