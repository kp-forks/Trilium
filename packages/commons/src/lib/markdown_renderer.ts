 ...
 * (preserving attributes and decoding their text to stay consistent with the title
 * comparison), and <h6> stays <h6> since there is no <h7> to shift into.
 */
function shiftHeadingsDown(content: string): string {
