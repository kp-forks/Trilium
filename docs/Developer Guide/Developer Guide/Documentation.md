# Documentation
There are multiple types of documentation for Trilium:<img class="image-style-align-right" src="api/images/T4do3CL7aUM7/Documentation_image.png" width="205" height="162">
