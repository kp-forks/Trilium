# Documentation
There are multiple types of documentation for Trilium:<img class="image-style-align-right" src="api/images/tVlfRhc5FzBP/Documentation_image.png" width="205" height="162">
