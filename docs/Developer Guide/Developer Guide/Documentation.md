# Documentation
There are multiple types of documentation for Trilium:<img class="image-style-align-right" src="api/images/9EFg0G8dUBHK/Documentation_image.png" width="205" height="162">
