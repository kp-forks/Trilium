...
| `tabWidth`, `indentWidthTabs`, `wrapLines` | Per-note Code editor settings: indentation width, indent with tabs vs. spaces, and word wrapping. See <a class="reference-link" href="../../Note%20Types/Code.md">Code</a>. |
