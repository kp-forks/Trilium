...
<table class="ck-table-resized">
    ...
    <tbody>
        <tr>
            ...
            <td><ul><li>Table of contents.</li><li>Syntax highlight of code blocks. The language is detected automatically, among the ones enabled in <a class="reference-link" href="../Basic%20Concepts%20and%20Features/UI%20Elements/Options.md">Options</a> → <em>Code Notes</em>.</li><li>Rendering for math equations.</li><li><a href="../Note%20Types/Text/Include%20Note.md">Including notes</a> (only if the included notes are also shared).</li></ul></td>
