# Recent Changes
<figure class="image image-style-align-center image_resized" style="width:50%;"><img style="aspect-ratio:988/572;" src="Recent Changes_image.png" width="988" height="572"></figure>

## Accessing the recent changes

*   For an overview of the changes across all documents, press the <span class="tn-icon bx bx-history"></span> button in the <a class="reference-link" href="Launch%20Bar.md">Launch Bar</a>.
