...
To individually select each note, press the <kbd spellcheck="false">Alt</kbd> key and click on the note to be selected.
...
To do so, first select the note to start the selection with. Then hold <kbd spellcheck="false">Shift</kbd> and click on the note to end the selection with. All the notes between the start and the end note will be selected as well.

## Selected notes vs. active note

There is a distinction between _selected notes_ and the _active note_:

*   _Selected notes_ are simply the notes that were selected in the multiple section process (i.e. either via <kbd spellcheck="false">Alt</kbd> or <kbd spellcheck="false">Shift</kbd>).
