...
describe("isWithinOverlay", () => {
    ...
    it("keeps the overlay open for the pane, the handle, the resize gutter, and allowlisted popups", () => {
        document.body.innerHTML = `
    ...
    it("dismisses for the spacer/backdrop, surrounding chrome, and non-elements", () => {
        document.body.innerHTML = `
            <div class="right-pane-overlay-spacer"></div>
        ...
        `;
        // The spacer/backdrop is deliberately outside the allowlist, so clicking the covered content dismisses.
        for (const selector of [".right-pane-overlay-spacer", ".editor", ".tab", ".tree-item"]) {
