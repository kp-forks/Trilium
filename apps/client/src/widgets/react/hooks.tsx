...
import { ShortcutHintDefinition, ShortcutHintProvider } from "../../services/shortcut_hints";
 ...
 * contextual shortcut help (Shift+F1 by default), the dispatcher walks up from the focused element
 ...
 *              the hints depend on component state).
 */
export function useContextualShortcutHints(hints: ShortcutHintDefinition | (() => ShortcutHintDefinition)) {
    ...
    useEffect(() => {
        ...
        const provider: ShortcutHintProvider = (collector) => {
            collector.add(...(typeof hints === "function" ? hints() : hints));
        };
