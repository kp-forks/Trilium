...
interface MediaPreviewProps {
    ...
    /** The tab showing the note; only the note detail has one. Enables siblings, play mode and the OS session. */
 ...
 */
export default function MediaPreview({ entity, environment = "standalone", noteContext, isVisible }: MediaPreviewProps) {
