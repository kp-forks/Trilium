...
export const ATTR_HELP: AttrHelpMap = {
    label: {
        ...
        "board:showInbox": t("attribute_detail.enable_inbox_column"),
        "board:columnWidth": t("attribute_detail.board_card_width"),
        "board:sortColumns": t("attribute_detail.sort_columns"),
        "board:sortColumnsDescending": t("attribute_detail.sort_columns_descending"),
