...
/**
 * Standalone runtime provider: reads the pre-built standalone meta (generated by edit-docs
 * using StandaloneInAppHelpProvider from the server package at build time).
 */
export default class StandaloneRuntimeInAppHelpProvider implements InAppHelpProvider {
